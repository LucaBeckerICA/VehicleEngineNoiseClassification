import kraftfahrzeuge_final.siamese_nn_raw as nn
import json
import numpy as np
import time
...
'''
files = ['pcen_dieselbenzin_N1024fs16kHZ_large_balanced.mat', 'pcen_lkwpkw_N256fs16kHz_balanced.mat',
         'mfccs_dieselbenzin_N1024Xi32_large_balanced.mat', 'mfccs_lkwpkw_N256Xi32t2sekK4_large_balanced.mat']
...
for i in range(cross_validations):
    ...
    accs[i], conf_mats[i, :, :] = nn.train_nn(files[1], learning, epochs, [0.15, 0.2], b, f, k, p, d, u)
...
current_destination_file = 'metrics_siamese_20cv20ep_' + files[1] + '.json'
